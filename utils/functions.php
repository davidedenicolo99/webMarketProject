...
function registerLoggedUser($user){
    ...
    $_SESSION["privilege"] = $user["attivo"];
    $_SESSION["password"] = $user["password"];
}

function getEmptyArticle(){
    return array("product_id" => "", "desccompletaformula" => "", "product_image" => "", "desccompletaformula" => "", "descformula" => "", "categorie" => array(), "quantity" => "", "product_price" => "", "product_name" => "");
}
...
function cartElement($productimg, $productname, $productprice, $productid, $productQnt){
    if(intval($productQnt)!=0){
        $single = $productprice/intval($productQnt);
    } else{
        $single = 0;
    }
